...
=======
  ...
  // Partículas optimizadas - MÁS GRANDES
...
=======
    <div className="min-h-screen relative flex items-center justify-end p-4 overflow-hidden">
      ...
      {/* Luces ambientales dinámicas - GRANDES para toda la pantalla */}
      <div className="absolute top-1/4 right-1/4 w-[800px] h-[800px] bg-primary/8 rounded-full blur-[150px] animate-float-ambient" />
      <div className="absolute bottom-1/4 right-1/3 w-[900px] h-[900px] bg-[#7C4A36]/8 rounded-full blur-[180px] animate-float-ambient-delayed" />
      <div className="absolute top-1/2 right-1/2 w-[700px] h-[700px] bg-white/5 rounded-full blur-[200px] animate-pulse-glow" />
      <div className="absolute bottom-1/3 right-1/4 w-[600px] h-[600px] bg-primary/6 rounded-full blur-[160px] animate-float-ambient" style={{ animationDelay: '3s' }} />
      ...
      <Card 
        className="w-full max-w-[420px] relative shadow-[0_0_80px_rgba(0,0,0,0.3)] border-0 bg-gradient-to-br from-white/[0.98] via-white/[0.95] to-white/[0.92] backdrop-blur-3xl overflow-hidden group lg:mr-12 z-20"
      ...
      >
        ...
        <CardHeader className="space-y-4 text-center relative z-10 pt-6 pb-4">
          ...
          <div className="relative mx-auto w-20 h-20 group/icon">
            ...
            {/* Círculo principal */}
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-primary via-primary/95 to-primary/80 shadow-[0_15px_40px_rgba(113,120,91,0.4)] transition-all duration-700 group-hover/icon:scale-110">
